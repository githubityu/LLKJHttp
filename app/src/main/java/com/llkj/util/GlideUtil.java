...
/**
 * Created by yujunlong on 2016/10/17.
 */
...
public class GlideUtil {
    ...
    public void loadBlurImage( ImageView imageView, String imgUrl) {
        Glide.with(imageView.getContext())
                ...
                .priority(Priority.NORMAL) //下载的优先级
                .diskCacheStrategy(DiskCacheStrategy.ALL) //缓存策略
                .bitmapTransform(new BlurTransformation(imageView.getContext(), Contants.BLUR_VALUE))
                .into(imageView);
    }
    ...
    public void loadBlurCircleImage(ImageView imageView, String imgUrl) {
        Glide.with(imageView.getContext())
                ...
                .diskCacheStrategy(DiskCacheStrategy.ALL) //缓存策略
                .bitmapTransform(
                        new BlurTransformation(imageView.getContext(), Contants.BLUR_VALUE),
        ...
        Glide.with(imageView.getContext())
                ...
                .bitmapTransform(
                        new RoundedCornersTransformation(
                                imageView.getContext(), Contants.CORNER_RADIUS, Contants.CORNER_RADIUS))
                .into(imageView);
    }
